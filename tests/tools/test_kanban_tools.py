...
def test_complete_with_artifacts_lands_in_event_payload(worker_env):
    ...
    gateway notifier can upload them as native attachments. See
    skills/productivity/deliverable-mode and the kanban notifier in
    gateway/run.py for the consumer side."""
    from hermes_cli import kanban_db as kb
    from tools import kanban_tools as kt
